...
object Dependencies extends AutoPlugin {
  ...
  object autoImport {
    ...
    lazy val OS_LIB          = "com.lihaoyi"            %% "os-lib"                     % "0.11.8"
    lazy val SQUANTS         = "org.typelevel"          %% "squants"                    % "1.7.4"
    lazy val TYPESAFE_CONFIG = "com.typesafe"            % "config"                     % "1.4.9"
    ...
    lazy val SCALA_TEST = Seq(
      ...
      "org.scalatest" %% "scalatest-matchers-core"  % "3.2.20",
      "org.scalatest" %% "scalatest-shouldmatchers" % "3.2.20",
      "org.scalatest" %% "scalatest-freespec"       % "3.2.20"
    )

    lazy val SPARK = Seq(
      "org.apache.spark" %% "spark-core" % "4.1.3",
      "org.apache.spark" %% "spark-sql"  % "4.1.3"
    )
